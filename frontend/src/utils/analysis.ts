...
import type { TimeseriesPoint, AnalyticsData } from '../types';
...
export interface AdvancedVolatilityMetrics {
    /** Standard Deviation of Returns - measures price deviation from average */
    stdDevReturns: number;
    /** Average True Range - average high-low range */
    atr: number;
    /** Price Range Volatility - high-low range as percentage */
    priceRangeVolatility: number;
    /** Margin Volatility - how much the margin changes over time */
    marginVolatility: number;
    /** Volume-Adjusted Price Volatility - combines price moves with volume */
    volumeAdjustedVolatility: number;
