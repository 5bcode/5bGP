                ...
                <PageHeader
                    title={
                        <div className="flex items-center gap-3">
                            {type === 'crash' ? (
                                <><ArrowDown size={28} className="text-rose-500" /> Crash Watch</>
                            ) : (
                                <><TrendingUp size={28} className="text-emerald-500" /> Opportunity Scanner</>
                            )}
                        </div>
                    }
                    subtitle={
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                            ...
                            <div className="flex gap-2 bg-slate-900 p-1 rounded-lg border border-slate-800">
                                <Select value={selectedStrategyId} onValueChange={setSelectedStrategyId}>
                                    <SelectTrigger className="w-[180px] border-none bg-transparent h-8 text-xs">
                                ...
                                {!currentStrategy.id.startsWith('default') && (
                                    <Button size="icon" variant="ghost" className="h-8 w-8 text-slate-500 hover:text-rose-500" onClick={handleDeleteStrategy}>
                                        <Trash2 size={14} />
                                    </Button>
                                )}
                            </div>
                            ...
                            <div className="bg-slate-900 border border-slate-800 rounded-lg p-1 inline-flex">
                                <Button
                                    ...
                                    className={type === 'flip' ? 'bg-emerald-600/20 text-emerald-400 h-8 text-xs' : 'text-slate-400 hover:text-slate-200 h-8 text-xs'}
                                >
                                    Flips
                                </Button>
                                <Button
                                    ...
                                    className={type === 'crash' ? 'bg-rose-600/20 text-rose-400 h-8 text-xs' : 'text-slate-400 hover:text-slate-200 h-8 text-xs'}
                                >
                                    Crashes
                                </Button>
                            </div>
